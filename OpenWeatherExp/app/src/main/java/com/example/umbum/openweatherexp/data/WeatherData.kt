...
* json parsing library에는 jackson도 있음. */
...
이 어노테이션을 붙이는 경우 어플리케이션이 뻗어버린다는 점이다.
 */
...
// @SerializedName을 쓴 필드가 존재하지 않으면 프로그램이 뻗어버리는데... 일단 Snow와 Rain은 빼고 진행. refac.
//data class SnowData(@SerializedName("3h") val snow: Int)
